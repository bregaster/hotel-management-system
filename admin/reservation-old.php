                    ...
                    <div class="col-md-5 col-sm-5">
                        <div class="panel panel-primary">
						    ...
						    <form name="form" method="post">
								...
								<div class="form-group">
                                    <label>Negara</label>
                                    <select name="negara" class="form-control" onchage="show()" required>
										<option value selected >
                                        <?php include ("db.php");
                                        $sql1 = "SELECT * FROM negara";
                                        $result1 = mysqli_query( $con, $sql1);
                                        while ($row1 = mysqli_fetch_array($result1, MYSQLI_ASSOC)){
                                            echo "<option value='$row1[kode_negara]'>$row1[nama_negara]</option>";
                                        }
                                        ?>
                                        </option>
                                    </select>
										...
										<option value selected >
                                            <?php include ("db.php");
                                                ...
                                                while ($row2 = mysqli_fetch_array($result2, MYSQLI_ASSOC)){
                                                    echo "<option value='$row2[kode_kota]'>$row2[nama_kota]</option>";
                                                }
                                            ?>
                                        </option>
                                    </select>
									    ...
									    if($data[0] > 1) {
                                            ...
                                            if(mysqli_query($con,$newUser)){
                                                ...
                                                if (mysqli_query($con,$newBook)){
                                                    ...
                                                    echo "<a href=succes.php?skid=".$id ."></a>";
                                                }else{
