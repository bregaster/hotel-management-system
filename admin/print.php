...
@page { margin: 0; }
	...
	$sql ="SELECT * FROM pembayaran A JOIN tamu B ON A.kode_tamu = B.kode_tamu JOIN reservasi C ON B.kode_tamu = C.kode_tamu JOIN tipe_kamar D ON C.kode_tipekamar = D.kode_tipekamar JOIN tipe_kasur E ON C.kode_kasur = E.kode_kasur where A.kode_tamu = '$pid' ";
	...
	while($row=mysqli_fetch_array($re))
	{
		...
		$quan = $row['jumlah'];
		$ttot = $row['harga'];
		$btot = $row['harga_kasur'];
		$fintot = $row['total_tagihan'];
		...
		<article>
			...
			<table class="inventory">
				...
				<tbody>
					<tr>
						...
						<td><span ><?php echo $quan;?> </span></td>
						<td><span data-prefix>Rp. </span><span><?php echo $ttot; ?></span></td>
					</tr>
					<tr>
						<td><span ><?php echo $bed; ?>  Bed </span></td>
						<td><span ><?php echo $days; ?></span></td>
						<td><span ><?php echo $quan;?> </span></td>
						<td><span data-prefix>Rp. </span><span><?php echo $btot; ?></span></td>
					</tr>
				</tbody>
			</table>
			...
			<table class="balance">
				...
				<tr>
					...
					<td><span data-prefix>Rp. </span><span >0.00</span></td>
				</tr>
				<tr>
