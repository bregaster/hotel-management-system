        ...
        <nav class="navbar-default navbar-side" role="navigation">
            <div class="sidebar-collapse">
                <ul class="nav" id="main-menu">
                    ...
                    <li>
                        <a class="active-menu" href="settings.php"><i class="fa fa-dashboard"></i>Daftar Admin</a>
                    </li>
        ...
        <div id="page-wrapper" >
            ...
            <div class="row">
                <div class="col-md-12">
					...
					<div class="panel-body">
						...
						if(isset($_POST['in']))
						{
							...
							$newsql ="INSERT INTO login (username,password) values ('$newus','$newps')";
							if(mysqli_query($con,$newsql))
							{
							echo '<script>alert("Username dan Password telah ditambah")</script>';
                            ...
                            <div class="modal fade" id="myModal" tabindex="-1" role="dialog" aria-labelledby="myModalLabel" aria-hidden="true">
                                <div class="modal-dialog">
                                    <div class="modal-content">
                                        ...
                                        <div class="modal-body">
                                            <div class="form-group">
                                            <label>Ganti ID</label>
                                            <input name="id" value="<?php echo $id; ?>" class="form-control" placeholder="Enter ID">
											</div>
										</div>
                                        <div class="modal-body">
                                            <div class="form-group">
				...
				if(isset($_POST['up']))
				{
					...
					$upsql = "UPDATE login SET id ='$id2',username ='$usname',password ='$passwr' WHERE id = '$id'";
					if(mysqli_query($con,$upsql))
					{
					echo '<script>alert("Username dan Password telah diupdate")</script>';
